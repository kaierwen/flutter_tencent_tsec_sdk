...
#define tsswiftclass(dname, rname)  class tsclassname(rname); @compatibility_alias dname tsclassname(rname)
#else
#define tsclassname(name)           name
#define tsmethodname(name)          name
#define tsclass(className)          class className
#define tsswiftclass(dname, rname)  class rname; @compatibility_alias dname rname
#endif
